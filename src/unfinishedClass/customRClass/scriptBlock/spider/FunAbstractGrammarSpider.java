...
import unfinishedClass.customRClass.scriptBlock.CommentRectGrammarSpider;
import unfinishedClass.customRClass.scriptBlock.GrammarSpider;
import unfinishedClass.customRClass.scriptBlock.ScriptBlock;
import unfinishedClass.customRClass.scriptBlock.SingleTypeGrammarSpider;
import unfinishedClass.customRClass.scriptBlock.VarFieldGrammarSpider;
import unfinishedClass.customRClass.scriptBlock.information.InformationType;

/**
 * 本类属于抽象类，
 * 添加了一些关于检查Function内部信息的方法，
 * 这个类扩展类用来检查ConFun、StaticFun、Fun、AbstractFun。
 * <p>（注意：请将本类和AbstractFunGrammarspider区分开来，
 * 本类属于抽象类，不能创建实例；
 * 而AbstractFunGrammarSpider属于本类的子类，
 * 是实体类，专门检查脚本中声明的抽象Function，
 * 可以创建实例）
 */
